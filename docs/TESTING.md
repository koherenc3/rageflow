...
| `phases.test.ts`      | The normal-normal learned lengths, the luteal update hook, and the phase of every day of a worked 28 day cycle                                                                                                                                                                           |
...
| `analysis.test.ts`    | The public `analyze` surface, purity of the function, entry-order independence, and forward compatibility with unknown entry kinds                                                                                                                                                       |

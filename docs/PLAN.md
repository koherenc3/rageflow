...
| `late`                | Today is on or past the predicted start, nothing logged                                 | Reports the days late, keeps the day of cycle, drops the ovulation estimate and the fertile and premenstrual windows everywhere they would show |

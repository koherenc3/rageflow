...
/**
 * Confidence shaping. `dataFactor = W / (W + saturation)` climbs from 0 with no
 * data towards 1; `precisionFactor` fades out as the predictive spread grows
 * past a day and a half and hits zero at the ceiling.
 */
export const CONFIDENCE_WEIGHT_SATURATION = 3;
export const CONFIDENCE_SD_FLOOR_DAYS = 1.5;
